        ...
        <div className="min-h-screen bg-gray-50">
            <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-3">
                ...
                {invitations.length > 0 && (
                    <span className="px-2 py-0.5 bg-primary-500 text-white rounded-full text-xs font-bold">
                        {invitations.length}
                    </span>
                )}
            </header>
            ...
            <main className="max-w-2xl mx-auto p-6">
                {isLoading ? (
                    ...
                    <div className="space-y-3">
                        {invitations.map((inv) => (
                            <div key={inv.token} className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-sm transition-shadow">
